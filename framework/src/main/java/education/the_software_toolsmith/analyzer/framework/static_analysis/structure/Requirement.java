...
import education.the_software_toolsmith.analyzer.framework.compliance.ComplianceStatus ;
...
import static education.the_software_toolsmith.analyzer.framework.compliance.ComplianceStatus.UNKNOWN ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.DO_LEAVE_AS_IS ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.DO_NOT_ADD ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.DO_NOT_DELETE ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.DO_NOT_MODIFY ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.OPTIONALLY_ADD ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.OPTIONALLY_DELETE ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.Behavior.OPTIONALLY_MODIFY ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.TargetType.CONSTRUCTOR ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.TargetType.GLOBALLY_APPLICABLE ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.structure.TargetType.METHOD ;
...
public class Requirement
    ...
    public Requirement( @JsonProperty( "behavior" ) final Behavior specifiedBehavior,
        ...
        // status
        this.complianceStatus = initialCompliance == null
                ? UNKNOWN
                : initialCompliance ;
