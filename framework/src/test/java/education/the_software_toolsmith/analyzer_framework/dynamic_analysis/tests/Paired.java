...
public final class Paired
     ...
     *
     * @return 0 if the two instances have the same value; a negative value if this should come before
     *     otherPaired; a positive value (greater than 0) if this should come after otherPaired
     */
    @Override
