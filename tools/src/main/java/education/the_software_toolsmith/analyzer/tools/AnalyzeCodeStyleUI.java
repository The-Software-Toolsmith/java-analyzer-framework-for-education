...
import static education.the_software_toolsmith.analyzer.framework.dynamic_analysis.TestingBase.findFiles ;
import static education.the_software_toolsmith.analyzer.framework.static_analysis.style.CodeStyleAnalyzer.* ;
 ...
 * @version 2.0 2026-01-10 rename from {@code ValidateCodingStyleUI} to {@code AnalyzeCodeStyleUI}
 */
public final class AnalyzeCodeStyleUI extends SharedState
    {
...
// DMR TODO map results by filename/full - support one pass across multiple submissions with distinct results
...
/* IN_PROCESS changed search starting point from ./ to ../ due to modularization */
        ...
        try
            ...
            System.out.printf( "%s%n", codeStyleAnalysisResults.get( EVERYTHING_KEY ).summary.toString() ) ;
            System.out.printf( "%s%n", codeStyleAnalysisResults.get( EVERYTHING_KEY ).report.toString() ) ;
            }
