...
public final class MethodInfo
    ...
    private ComplianceStatus isCompliant ;
    ...
    public MethodInfo( final String name,
                       ...
                       final ComplianceStatus isMethodCompliant )
        {
     ...
     */
    public ComplianceStatus setCompliance( final ComplianceStatus newCompliance )
        {

        final ComplianceStatus savedCompliance = this.isCompliant ;
